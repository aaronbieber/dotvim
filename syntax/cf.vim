...
syn region  cfComment     start='<!---' end='--->' keepend contains=cfCommentTodo,cfFoldTitle,@Spell
syn keyword cfCommentTodo contained TODO FIXME XXX TBD WTF 

syn region cfFoldTitle    start=+\s\{1\}group:+ms=s+1 end=+ {{{+me=e-4 containedin=cfComment
...
syn include @cfSql <sfile>:p:h/sqlanywhere.vim
unlet b:current_syntax
...
hi cfFoldTitle gui=bold guibg=#E3DCBC guifg=#486277
